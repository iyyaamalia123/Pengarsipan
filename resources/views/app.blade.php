...
<body class="">
    <div class="wrapper ">
      ...
      -->
            <div class="logo"><a href="" class="simple-text logo-normal">Pengarsipan
                    File</a></div>
            <div class="sidebar-wrapper ps-container ps-theme-default ps-active-y"
                data-ps-id="04e51da9-50e4-8ba2-6329-2c4fd1671545">
                <ul class="nav">
                    ...
                    <li class="nav-item ">
                        <a class="nav-link" href="{{ url('/filemanager') }}">
                            <i class="fas fa-file-import"></i>
                            <p>Inventaris Perusahaan</p>
                        </a>
                    </li>
                
                    <li class="nav-item ">
                        <a class="nav-link" href="{{ url('_data__karyawan') }}">
                            <i class="fas fa-file-import"></i>
                            <p>Data Karyawan</p>
                        </a>
                    </li>
                ...
                <div class="ps-scrollbar-y-rail" style="top: 0px; height: 257px; right: 0px;">
                    <div class="ps-scrollbar-y" tabindex="0" style="top: 0px; height: 235px;"></div>
                </div>
                <div class="ps-scrollbar-x-rail" style="left: 0px; bottom: 0px;">
                    <div class="ps-scrollbar-x" tabindex="0" style="left: 0px; width: 0px;"></div>
                </div>
                <div class="ps-scrollbar-y-rail" style="top: 0px; height: 257px; right: 0px;">
                    <div class="ps-scrollbar-y" tabindex="0" style="top: 0px; height: 194px;"></div>
                </div>
            </div>
        ...
        <div class="main-panel ps-container ps-theme-default ps-active-y"
            data-ps-id="28f0e3d7-d1e8-b339-bd6b-94b7cb122208">
            <!-- Navbar -->
            <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
                <div class="container-fluid">
                    <div class="navbar-wrapper">
                        <a class="navbar-brand" href="javascript:;">PT Mataram Inti Konstruksi </a>     
                    </div>
            ...
            <div class="ps-scrollbar-y-rail" style="top: 0px; height: 332px; right: 0px;">
                <div class="ps-scrollbar-y" tabindex="0" style="top: 0px; height: 111px;"></div>
            </div>
        </div>
    </div>
    <!--   Core JS Files   -->
