<html lang="en" class="perfect-scrollbar-on"><head>
  ...
  <body class="">
    <div class="wrapper ">
      <div class="sidebar" data-color="purple" data-background-color="white" data-image="http://127.0.0.1:8000/assets/img/sidebar-1.jpg">
        <!--
          Tip 1: You can change the color of the sidebar using: data-color="purple | azure | green | orange | danger"
  
          Tip 2: you can also add an image using data-image tag
      -->
        <div class="logo"><a href="http://www.creative-tim.com" class="simple-text logo-normal">Penggajian Karyawan</a></div>
        <div class="sidebar-wrapper ps-container ps-theme-default ps-active-y" data-ps-id="04e51da9-50e4-8ba2-6329-2c4fd1671545">
          <ul class="nav">
            ...
            <li class="nav-item ">
              <a class="nav-link" href="http://127.0.0.1:8000/data_karyawan">
                <i class="material-icons">person</i>
                <p>Data Karyawan</p>
              </a>
            </li>
            <li class="nav-item ">
              <a class="nav-link" href="http://127.0.0.1:8000/gaji_karyawan">
                <i class="material-icons">content_paste</i>
                <p>Gaji Karyawan</p>
              </a>
            </li>
            <li class="nav-item ">
              <a class="nav-link" href="http://127.0.0.1:8000/golongan">
        ...
        <div class="ps-scrollbar-x-rail" style="left: 0px; bottom: 0px;"><div class="ps-scrollbar-x" tabindex="0" style="left: 0px; width: 0px;"></div></div><div class="ps-scrollbar-y-rail" style="top: 0px; height: 257px; right: 0px;"><div class="ps-scrollbar-y" tabindex="0" style="top: 0px; height: 235px;"></div></div><div class="ps-scrollbar-x-rail" style="left: 0px; bottom: 0px;"><div class="ps-scrollbar-x" tabindex="0" style="left: 0px; width: 0px;"></div></div><div class="ps-scrollbar-y-rail" style="top: 0px; height: 257px; right: 0px;"><div class="ps-scrollbar-y" tabindex="0" style="top: 0px; height: 194px;"></div></div></div>
      <div class="sidebar-background" style="background-image: url(http://127.0.0.1:8000/assets/img/sidebar-1.jpg) "></div><div class="sidebar-background" style="background-image: url(http://127.0.0.1:8000/assets/img/sidebar-1.jpg) "></div></div>
      <div class="main-panel ps-container ps-theme-default ps-active-y" data-ps-id="28f0e3d7-d1e8-b339-bd6b-94b7cb122208">
        <!-- Navbar -->
        <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
          <div class="container-fluid">
            <div class="navbar-wrapper">
              <a class="navbar-brand" href="javascript:;">Selamat Datang Di Aplikasi Penggajian</a>
            </div>
    ...
    <script src="http://127.0.0.1:8000/assets/js/plugins/sweetalert2.js"></script>
    <!-- Forms Validations Plugin -->
    <script src="http://127.0.0.1:8000/assets/js/plugins/jquery.validate.min.js"></script>
    <!-- Plugin for the Wizard, full documentation here: https://github.com/VinceG/twitter-bootstrap-wizard -->
    <script src="http://127.0.0.1:8000/assets/js/plugins/jquery.bootstrap-wizard.js"></script>
    ...
    <script src="http://127.0.0.1:8000/assets/js/plugins/jquery-jvectormap.js"></script>
    <!--  Plugin for the Sliders, full documentation here: http://refreshless.com/nouislider/ -->
    <script src="http://127.0.0.1:8000/assets/js/plugins/nouislider.min.js"></script>
    ...
    <!-- Chartist JS -->
    <script src="http://127.0.0.1:8000/assets/js/plugins/chartist.min.js"></script>
