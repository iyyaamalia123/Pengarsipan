...
<div class="col-md-12">
    <div class="card">
      ...
      <div class="card-body">
        <form enctype="multipart/form-data" method="POST" action="{{route('data_karyawan.store')}}">
            @csrf
          <div class="row">
            <div class="col-md-12">
            ...
            <div class="col-md-12">
                <div class="form-group">
                  ...
                  <select name="golongan_id" type="text" class="form-control" id="golongan_id">
                    ...
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <div class="form-group">
                          ...
                          <textarea id="alamat_karyawan" class="form-control" rows="5" name="alamat_karyawan"></textarea>
                        </div>
                      </div>
                    </div>
                  </div>
